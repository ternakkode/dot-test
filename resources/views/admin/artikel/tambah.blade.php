        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input required type="text" class="form-control" name="kategori" id="kategori">
                </div>
                <div class="form-group">
                    <label>Foto Headline</label>
                    <div class="custom-file">
                        <input required type="file" class="custom-file-input" id="headline" name="headline">
                        <label class="custom-file-label" for="customFile">Choose file</label>
                    </div>
                </div>
                <div class="form-group">
                    <label>Isi Artikel</label>
                    <textarea name="isi_artikel" id="isi_artikel" class="editor">
                    </textarea>
                </div>
            </div>
